...
<script>
	...
	$(document).ready(function(){
		...
		eventClick:function(info){
			...
			uni_modal("<i class='fa fa-calendar-day'></i> Schedule Details", "schedules/view_schedule.php?id=" + id)
		}
		});
...
<script>
function verify(){
  var schedule_from = document.getElementById('schedule_from').value;
  alert(schedule_from);
  $.ajax({
   url:"verify_input.php",
   method:"POST",
   data:{schedule_from:schedule_from},
   success:function(data){
    $('#date_verify').html(data);
   }
  })
 };
</script>